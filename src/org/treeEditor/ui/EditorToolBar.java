...
public class EditorToolBar extends JToolBar {
    ...
    public EditorToolBar(final BasicGraphEditor editor, int orientation) {
        ...
        this.add(editor.bind(
                "Open",
                new OpenAction(),
                "open.gif")).setToolTipText(mxResources.get("open")); //index = 0
        this.add(editor.bind(
                "Save",
                new SaveAction(SaveAction.NOTSHOWDIALOG),
                "save.gif")).setToolTipText(mxResources.get("save")); //index = 1
        ...
        this.add(editor.bind(
                "Print",
                new PrintAction(),
                "print.gif")).setToolTipText(mxResources.get("print")); //index = 3
     ...
     */
        ...
        graphToolBar.add(editor.bind(
                ...
                "cut.gif")).setToolTipText(mxResources.get("cut"));
        graphToolBar.add(editor.bind(
                mxResources.get("copy"),
                TransferHandler.getCopyAction(),
                "copy.gif")).setToolTipText(mxResources.get("copy"));
        graphToolBar.add(editor.bind(
                mxResources.get("paste"),
                TransferHandler.getPasteAction(),
                "paste.gif")).setToolTipText(mxResources.get("paste"));
        ...
        graphToolBar.add(editor.bind(
                ...
                "selectall.gif")).setToolTipText(mxResources.get("selectAll"));
        graphToolBar.add(editor.bind(
                mxResources.get("selectNone"),
                mxGraphActions.getSelectNoneAction(),
                "selectnone.gif")).setToolTipText(mxResources.get("selectNone"));
        graphToolBar.add(editor.bind(
                mxResources.get("delete"),
                mxGraphActions.getDeleteAction(),
                "delete.gif")).setToolTipText(mxResources.get("delete"));
        ...
        graphToolBar.add(editor.bind(
                ...
                "undo.gif")).setToolTipText(mxResources.get("undo"));
        graphToolBar.add(editor.bind(
                mxResources.get("redo"),
                new HistoryAction(HistoryAction.REDO),
                "redo.gif")).setToolTipText(mxResources.get("redo"));
        ...
        graphToolBar.add(editor.bind(
                ...
                new GraphToText(),
                "graphtotext.gif")).setToolTipText(mxResources.get("graphToText"));
     ...
     */
        ...
        textToolBar.add(editor.bind(
                ...
                "text-addtag.png")).setToolTipText(mxResources.get("addTag"));
        textToolBar.add(editor.bind(
                mxResources.get("replaceTag"),
                new TextReplaceAction(TextReplaceAction.TAG),
                "text-replacetag.png")).setToolTipText(mxResources.get("replaceTag"));
        ...
        textToolBar.add(editor.bind(
                ...
                "text-addattr.png")).setToolTipText(mxResources.get("addAttr"));
        textToolBar.add(editor.bind(
                mxResources.get("replaceAttr"),
                new TextReplaceAction(TextReplaceAction.ATTR),
                "text-replaceattr.png")).setToolTipText(mxResources.get("replaceAttr"));
        ...
        textToolBar.add(editor.bind(
                ...
                "text-addblank.png")).setToolTipText(mxResources.get("addBlank"));

        textToolBar.add(editor.bind(
                mxResources.get("delete"),
                new TextDeleteAction(),
                "text-delete.png")).setToolTipText(mxResources.get("delete"));
        ...
        textToolBar.add(editor.bind(
                ...
                "text-undo.png")).setToolTipText(mxResources.get("undo"));
        textToolBar.add(editor.bind(
                mxResources.get("redo"),
                new TextHistoryAction(TextHistoryAction.REDO),
                "text-redo.png")).setToolTipText(mxResources.get("redo"));
        ...
        textToolBar.add(editor.bind(
                ...
                new MatchAction(),
                "text-match.gif")).setToolTipText(mxResources.get("match"));

        textToolBar.add(editor.bind(
                mxResources.get("showThisTags"),
                new ShowThisTagsAction(),
                "text-showthistags.png")).setToolTipText(mxResources.get("showThisTags"));

        textToolBar.add(editor.bind(
                mxResources.get("removeOtherTags"),
                new RemoveOtherTagsAction(),
                "text-removeothertags.png")).setToolTipText(mxResources.get("removeOtherTags"));
        ...
        textToolBar.add(editor.bind(
                ...
                new RepaintAction(),
                "text-repaint.gif")).setToolTipText(mxResources.get("repaint"));
     ...
     */
        ...
        this.add(editor.bind(
                "pre",
                new PreAction(),
                "pre.gif")).setToolTipText(mxResources.get("pre")); //index = 8
        this.add(editor.bind(
                "next",
                new NextAction(),
                "next.gif")).setToolTipText(mxResources.get("next")); //index = 9
...
//    pageCombo.setSelectedIndex(toolBarComboBoxIndex);
     ...
     */
        this.add(editor.bind(
                ...
                "zoomin.gif")).setToolTipText(mxResources.get("zoomIn")); //index = 13

        this.add(editor.bind(
                "zoomOut",
                mxGraphActions.getZoomOutAction(),
                "zoomout.gif")).setToolTipText(mxResources.get("zoomOut")); //index = 14
