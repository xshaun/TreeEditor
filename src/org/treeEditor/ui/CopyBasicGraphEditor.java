...
//import org.treeEditor.TreeEditor;
...
//
//
//public class CopyBasicGraphEditor extends JPanel {
//
//    /**
//     *
//     */
...
//    static {
//        try {
//            mxResources.add("org/treeEditor/resources/ui");
//        } catch (Exception e) {
//            // ignore
//        }
//    }
...
//     *
//     */
//    public CopyBasicGraphEditor(String appTitle) {
...
//            Document doc = mxUtils.loadDocument(TreeEditor.class.loadResource(
...
//                        || e.isControlDown()) {
//                    CopyBasicGraphEditor.this.mouseWheelMoved(e);
//                }
//            }
//
//        };
...
//                CopyBasicGraphEditor.class.loadResource(iconUrl)) : null) {
...
//        frame.setIconImage(frame.getToolkit().loadImage(CopyBasicGraphEditor.class.loadResource("/cn/edu/zzu/nlp/images/logo.gif")));
//
//        //窗口关闭时进行检测
//        frame.addWindowListener(new WindowAdapter() {
//            public void windowClosing(WindowEvent e) {
//                JFrame component = (JFrame) e.getSource();
//                CopyBasicGraphEditor editor = (CopyBasicGraphEditor) component.getContentPane().getComponent(0);
//                if (!editor.exit()) {
